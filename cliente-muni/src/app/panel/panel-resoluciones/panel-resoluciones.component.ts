...
@Component({
  selector: 'app-panel-resoluciones',
  templateUrl: './panel-resoluciones.component.html',
  styleUrls: ['./panel-resoluciones.component.css']
})
export class PanelResolucionesComponent implements OnInit {

  URI = GlobalConstants.apiURL;
  convocatorias: Resolucion[];
  convocatoria: Resolucion;
  pages;
  file: File;
  ...
  constructor(private service: PanelResolucionesService, private toastr: ToastrService) {
    this.ready = false;
    this.convocatoria = new Resolucion();
    this.btn = true;
    this.pageActive = 1;
    this.pageSize = 20;
    this.paginar();
