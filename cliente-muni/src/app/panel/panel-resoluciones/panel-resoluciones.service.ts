...
export class PanelResolucionesService {
  ...
  postData(convocatoria, file: File){ 
    ...
    form_data.append('inputTIP', convocatoria.tipo);
    form_data.append('file', file);
    return this.http.post(this.URI+'panel/resoluciones/ajax_registrar.php',form_data);
  }
  ...
  putData(convocatoria, file: File){ 
    ...
    return this.http.post(this.URI+'panel/resoluciones/ajax_editar.php',form_data);
  }
  ...
  deleteData(convocatoria){
    ...
    return this.http.get(this.URI+'panel/resoluciones/ajax_eliminar.php',{params: params});
  }

  getDataFilter(index: string){
    let params = new HttpParams();
    params = params.append('index', index);
    return this.http.get<[]>(this.URI+'panel/resoluciones/ajax_buscar.php',{params: params});
  }
