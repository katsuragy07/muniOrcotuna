    ...
    if($editURL){
        ...
        if(!empty($_FILES["inputIMG"]["type"])){
            ...
            if((($_FILES["inputIMG"]["type"] == "video/mp4") || ($_FILES["inputIMG"]["type"] == "video/webm") || ($_FILES["inputIMG"]["type"] == "video/ogv") || ($_FILES["inputIMG"]["type"] == "image/png") || ($_FILES["inputIMG"]["type"] == "image/jpg") || ($_FILES["inputIMG"]["type"] == "image/jpeg")) && in_array($file_extension, $valid_extensions)){
                ...
                $targetPath = URI."upload/anuncios/".$fileName;
        ...
        if($resultadoUP){
            $query = "INSERT INTO anuncios(nombre,inicio,referencia,fecha,url_img) VALUES ('$nombres','$inicio','$referencia',now(),'$uploadedFile');";   
        }
        
    }else{
        $query = "INSERT INTO anuncios(nombre,inicio,referencia,fecha) VALUES ('$nombres','$inicio','$referencia',now());"; 
        $resultadoUP = true;
    }
